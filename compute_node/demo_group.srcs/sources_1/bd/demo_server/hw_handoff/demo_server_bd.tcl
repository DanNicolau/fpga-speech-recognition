...
################################################################
# This is a generated script based on design: demo_server
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: euclidean_dist_0, and set properties
  set euclidean_dist_0 [ create_bd_cell -type ip -vlnv utoronto.ca:user:euclidean_dist:1.0 euclidean_dist_0 ]

  # Create instance: fft_word_clip_0, and set properties
  set fft_word_clip_0 [ create_bd_cell -type ip -vlnv utoronto.ca:user:fft_word_clip:1.0 fft_word_clip_0 ]
  ...
  # Create instance: word_clipper_0, and set properties
  set word_clipper_0 [ create_bd_cell -type ip -vlnv utoronto.ca:user:word_clipper:1.0 word_clipper_0 ]
  set_property -dict [ list \
   CONFIG.C_S00_WORD_CLIP_AXI_LOW_THRESHOLD {"000000000100001"} \
   CONFIG.C_S00_WORD_CLIP_AXI_SAMPLE_NUM {32} \
   CONFIG.C_S00_WORD_CLIP_AXI_UP_THRESHOLD {"000000101001000"} \
 ] $word_clipper_0
...
connect_bd_intf_net -intf_net [get_bd_intf_nets microblaze_0_axi_periph_M01_AXI] [get_bd_intf_pins ila_0/SLOT_0_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI] [get_bd_intf_pins word_clipper_0/S00_WORD_CLIP_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins fft_word_clip_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins euclidean_dist_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_ethernetlite_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins euclidean_dist_0/s00_axi_aresetn] [get_bd_pins fft_word_clip_0/s00_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins word_clipper_0/s00_word_clip_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs euclidean_dist_0/S00_AXI/S00_AXI_reg] SEG_euclidean_dist_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00020000 -offset 0x43A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs fft_word_clip_0/S00_AXI/S00_AXI_reg] SEG_fft_word_clip_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00020000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs word_clipper_0/S00_WORD_CLIP_AXI/S00_WORD_CLIP_AXI_reg] SEG_word_clipper_0_S00_WORD_CLIP_AXI_reg
